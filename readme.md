...
и т.д.<br>
<br>
То есть от числа 2 идух ребра ко всем числам больше 2-х, от числа 3 ко всем числам больше 3-х и т.д.<br>
<br>
...
хранится список тупиков узлов - либо сумма не будет достигнута, либо сумма будет превышена, либо правая часть не будет собрана. 
